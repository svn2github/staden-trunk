...
# "tablelistConfig.tcl", "tablelistMove.tcl", "tablelistSort.tcl", and
# "tablelistUtil.tcl" by defining the procedure "arrElemExists" and replacing
# all invocations of "[info exists <array>(<name>)]" with "[arrElemExists
# <array> <name>]".  This works around a bug in Tcl versions 8.2, 8.3.0 -
# 8.3.2, and 8.4a1 (fixed in Tcl 8.3.3 and 8.4a2), which causes excessive
# memory use when calling "info exists" on non-existent array elements.
#
