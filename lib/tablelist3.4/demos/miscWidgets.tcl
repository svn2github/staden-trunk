...
option add *Tablelist*Spinbox.background		ivory
option add *Tablelist*Spinbox.readonlyBackground	ivory
option add *Tablelist*Combobox.background		ivory
option add *Tablelist*Combobox.elementBorderWidth	2
option add *Tablelist*Mentry.background			ivory
