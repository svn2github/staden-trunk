...
distribution file is "tablelist3.4.tar.gz" for UNIX and
"tablelist3_4.zip" for Windows.  These files contain the same
...
the distribution file "tablelist3.4.tar.gz":

    gunzip -c tablelist3.4.tar.gz | tar -xf -

This command will create a directory named "tablelist3.4", with the
subdirectories "demos", "doc", "images", and "scripts".

On Windows, use WinZip or some other program capable of unpacking the
distribution file "tablelist3_4.zip" into the directory "tablelist3.4",
