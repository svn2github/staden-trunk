...
#
# RCS: @(#) $Id: tkfbox.tcl,v 1.2 2004-06-30 14:29:29 jkbonfield Exp $
#
...
proc ::tk::dialog::file:: {type args} {
    ...
    if {[info exists ::tk::MotifFilebrowser] && $::tk::MotifFilebrowser == 1} {
	return [eval ::tk::MotifFDialog $type $args]
    }
