...
#define SEQ_RESULT_UPDATE 16
#define SEQ_GET_BRIEF_TAG 17
...
cursor_t *create_cursor(int seq_num, int private, char *colour, 
			int line_width, int new_cursor, int direction, int pos);
