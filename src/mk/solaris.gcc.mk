...
SHLIB_CFLAGS		=
SHLIB_LD      		= ld
SHLIB_LDFLAGS 		= $(SHLIB_STRIP) $(LINK_PATHFLAG)$(L) -G -o
SHLIB_PREFIX		= lib
SHLIB_SUFFIX		= .so
SHLIB_SONAME		=
SHLIB_DEP		= -Bdynamic -ldl -lresolv
CLDFLAGS_E	       += -R '$$ORIGIN/../lib/$(O)'
FLDFLAGS_E	       += -R '$$ORIGIN/../lib/$(O)'
F77_DEP			= -L/opt/SUNWspro/SC2.0.1 -L/opt/SUNWspro/SC4.2/lib -Bstatic -lF77 -lsunmath -lm
