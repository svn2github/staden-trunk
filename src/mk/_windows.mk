...
#
# Always link against non-debug C-Runtime library otherwise strange things
# begin to happen! If the non-debug version is loaded first via sprun.exe,
# then wish loads the debug version, we have two copies and major problems
# then ensue.
#

CRTLIBS       = /NODEFAULTLIB:msvcrtd.lib msvcrt.lib
...
CLDDEBUG      = /DEBUG $(CRTLIBS) /MACHINE:IX86
...
# Extra final link objects needed especially by windows.
